...
@Tag(name = "Campeões", description = "Endpoints do domínio de Campeões do LOL.") //Swagger
@RestController
...
public record AskChampionRestController(AskChampionUseCase useCase){
    ...
    public record AskChampionRequest(String question){} //DTO
    public record AskChampionResponse(String answer){} //DTO
